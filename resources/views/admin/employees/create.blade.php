                    ...
                    <div class="card-header bg-info">
                        ...
                        <div class="actions">
                            <button class="btn btn-primary btn-sm"
                                onclick="location.href='{{ route('employees.index') }}'">
                                <i class="icon-fa "></i> Back</button>
                        </div>
                    </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="first_name"
                                                    class="form-control input-md autocomplete_off" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="date_of_birth" type="text"
                                                    class="form-control ls-datepicker autocomplete_off" value=""
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control ls-select2" style="width: 100%;" name="country"
                                                    required>
                                                    <option value="Singapore" selected="selected">Pakistan</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control ls-select2" style="width: 100%;"
                                                    name="blood_group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id_number"
                                            class="form-control input-md autocomplete_off">
                                    </div>

                                    <div class="form-group">
                                        <label>Religious</label>
                                        <select class="form-control select2" style="width: 100%;" name="religious">
                                            <option value="Muslims" selected="selected">Muslims</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="css-input css-radio css-radio-success push-10-r">
                                                    <input name="gender" value="Male" checked=""
                                                        type="radio"><span></span>Male
                                                </label>
                                                <label class="css-input css-radio css-radio-success push-10-r">
                                                    <input name="gender" value="Female"
                                                        type="radio"><span></span>Female
                                                </label>
                                            </div>
                                        </div>
                                    </div>
