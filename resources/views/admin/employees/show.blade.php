                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div class="form-group form-group-bottom">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="date_of_birth" type="text"
                                                        class="form-control ls-datepicker autocomplete_off"
                                                        value="{{ $employee->dob }}" data-date-format="yyyy-mm-dd"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                @if ($employee->gender == 'Male')
                                                    <label class="css-input css-radio css-radio-success push-10-r">
                                                        <input name="gender" value="Male" checked=""
                                                            type="radio" disabled="disabled"><span></span>Male
                                                    </label>
                                                    <label class="css-input css-radio css-radio-success push-10-r">
                                                ...
                                                @else
                                                    ...
                                                    <label class="css-input css-radio css-radio-success push-10-r">
                                                        <input name="gender" value="Female" checked=""
                                                            type="radio" disabled="disabled"><span></span>Female
                                                    </label>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        @if ($employee->photo != null)
                                            <img src="/employeesPhoto/{{ $employee->photo }}"
                                                alt="{{ $employee->photo }}" style="max-width:200px;max-height:200px">
                                        @else
                                            <img src="{{ asset('/assets/admin/img/avatars/user.png') }}" alt="Avatar"
                                                style="max-width:200px;max-height:200px"></a>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        <input type="file" name="employee_photo" id="file-1"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <form action="{{ route('employeeAttachments.delete') }}" method="post"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label class="css-input css-checkbox css-checkbox-success">
                                                                <input name="personalAttach[]"
                                                                    value="{{ $attachment->id }}" type="checkbox"
                                                                    class="child_present"><span></span>
                                                            </label>
                                                        </td>
                                                        <td><a
                                                                href="/employeeAttachments/{{ $attachment->name }}">{{ $attachment->name }}</a>
                                                        </td>
                                                        <td>{{ $attachment->description }}</td>

                                                        <td>{{ Carbon\Carbon::parse($attachment->created_at)->format('d M Y') }}
                                                        </td>
