        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-xs-9">
                <div class="card">
                    ...
                    <form id="SalaryForm" action="{{ route('employeeSalaries.update', $salary->id) }}"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="well well-lg">
                                        ...
                                        <input type="radio" name="type" value="Monthly" checked=""
                                            onclick="show_monthly();">
                                        Monthly Salary &nbsp;&nbsp;&nbsp;
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" name="basic_payment"
                                                        class="form-control key earning autocomplete_off" id="earn1"
                                                        value="{{ $salary->basic_payment }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" name="car_allowance"
                                                        class="form-control key earning autocomplete_off" id="earn2"
                                                        value="{{ $salary->car_allowance }}">
                                                    <span class="required" id="errorSalaryRange"></span>
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" name="medical_allowance"
                                                        class="form-control key earning autocomplete_off" id="earn3"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" name="living_allowance"
                                                        class="form-control key earning autocomplete_off" id="earn4"
                                                        value="{{ $salary->living_allowance }}">
                                                    <span class="required" id="errorSalaryRange"></span>
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" name="house_rent"
                                                        class="form-control key earning autocomplete_off" id="earn8"
                                                        value="{{ $salary->house_rent }}">
                                                    <span class="required" id="errorSalaryRange"></span>
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" name="gratuity"
                                                        class="form-control key deduction autocomplete_off" id="earn5"
                                                        value="{{ $salary->gratuity }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" name="pension"
                                                        class="form-control key deduction autocomplete_off" id="earn6"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" name="insurance"
                                                        class="form-control key deduction autocomplete_off" id="earn7"
                        ...
                        <div class="card-footer">
                            ...
                            <button id="saveSalary" type="submit" class="btn bg-success btn-flat"
