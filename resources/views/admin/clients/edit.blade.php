            ...
            <div class="modal-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id='inp_name' type="text" name="name" value=""
                                class="form-control input-md inp_client_name" required>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group form-group-bottom">
                            <label>Website</label>
                            <input id='inp_website' type="text" name="website"
                                class="form-control input-md inp_website" value="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group form-group-bottom">
                            ...
                            <input id='inp_fax' type="text" name="fax" class="form-control input-md inp_fax"
                                value="">
                        </div>
                    </div>
                </div>
