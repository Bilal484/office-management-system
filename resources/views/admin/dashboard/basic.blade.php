        ...
        <div class="row">
            <div class="col-lg-12 col-xl-6 mt-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="dashboard-new-orders-datatable" class="table table-striped table-bordered"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-default btn-xs"
                                                    href="/admin/orders/{{ $order->id }}">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
            ...
            <div class="col-lg-12 col-xl-6 mt-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="dashboard-new-customers-datatable"
                            class="table table-striped table-bordered responsive-datatable" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>Customer Name</th>
                                    <th>Date</th>
                                    ...
                                    @foreach ($clients as $client)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-default btn-xs view" href="#" data-toggle="modal"
                                                    data-target="#modal-view">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
