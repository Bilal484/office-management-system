...
Route::group([
    ...
    Route::put('/admin/inventory/{inventory}', 'InventoryController@update')->name('inventory.update');
    ...
    // Attendance Employee
    Route::post('attendance/clock-in', 'AttendanceemployeeController@clockIn')->name('attendance.clock-in');
    Route::post('attendance/clock-out', 'AttendanceemployeeController@clockOut')->name('attendance.clock-out');
    Route::post('attendance/mark', 'AttendanceemployeeController@markAttendance')->name('attendance.mark');
    Route::post('/attendance/daily', 'AttendanceController@dailyAttendance');
    Route::post('/attendance/my-attendance', [AttendanceemployeeController::class, 'myAttendance'])->name('attendance.my-attendance');
    // sidebar fatech route 
    Route::get('/employees/attendance', 'AttendanceemployeeController@attendance')->name('admin/employees/attendance');
});
